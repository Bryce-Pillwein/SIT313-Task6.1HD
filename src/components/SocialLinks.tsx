      ...
      <div className="flex items-center gap-x-8">
        ...
        <a rel="noopener noreferrer" target="_blank" href="https://www.linkedin.com">
          <svg viewBox="0 0 195 195" width={size} height={size} fill={fill}>
            <path clipRule="evenodd" d="M179.88 0H14.57C6.49 0 0 6.53 0 14.16v166.68C0 188.47 6.48 195 14.59 195h165.83c8.1 0 14.58-6.53 14.58-14.16V14.16C194.46 6.53 187.98 0 179.87 0zM28.63 73.5h28.63v93.64H28.63V73.5zm14.59-46.28A16.9 16.9 0 0159.95 44.1a16.9 16.9 0 01-16.74 16.88A16.9 16.9 0 0126.47 44.1c0-9.8 7.56-16.88 16.75-16.88zm59.94 46.28H75.61v92.56h29.17v-46.28c0-11.98 2.16-23.95 17.29-23.95 15.12 0 15.12 14.15 15.12 25.04v45.73h28.63v-51.17c0-25.05-5.4-44.65-34.57-44.65-14.04 0-23.77 7.62-27.55 15.25h-.54V73.5z" fillRule="evenodd" id="linkedin"></path>
          </svg>
        </a>
