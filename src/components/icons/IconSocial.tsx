...
const IconSocial: React.FC<IconSocialProps> = ({ type, size = 24, fill = 'hsl(0 0% 50%)' }) => {
  switch (type) {
    case 'facebook':
      return (
        <svg fill={fill} height={size} width={size} viewBox="0 0 24 24" >
          <path d="M20,2H4C2.9,2,2,2.9,2,4v16c0,1.1,0.9,2,2,2h16c1.1,0,2-0.9,2-2V4C22,2.9,21.1,2,20,2z M18.4,7.4H17c-0.9,0-1,0.3-1,1v1.3 h2.1L18,12h-1.9v7h-3.2v-7h-1.2V9.6h1.2V8.1c0-2,0.8-3.1,3.1-3.1h2.4V7.4z"></path>
        </svg>
      );
    case 'instagram':
      return (
        <svg fill={fill} height={size} width={size} viewBox="-143 145 512 512" >
