...
const PostDetailedModal: React.FC<PostDetailedModalProps> = ({ pd, onClose }) => {
  ...
  return createPortal(
    <div className='fixed top-0 left-0 w-[100vw] h-[100vh] bg-black bg-opacity-70 flex flex-col justify-center items-center z-50'>
      <div className="bg-hsl-l98 dark:bg-hsl-l13  rounded-md flex flex-col min-w-[50%] max-w-[98%] mb:max-w-[90%] lg:max-w-[60%] min-h-[60%] max-h-[90%]">
        ...
        <div className='flex justify-end gap-4 mt-auto mb-8 mr-8'>
